  ...
  return (
    <div className="py-12 bg-white">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2">Our Clubs</h1>
        <p className="text-slate-700 text-lg">Explore the diverse range of clubs at our college and discover your passions.</p>
      </div>
