...
const EventCreation: React.FC = () => {
  ...
  const [formCreator, setFormCreator] = useState(true);
  const [eventID, setEventID] = useState(null);
  ...
  return (
    <div
      className="rounded-tl-2xl rounded-br-2xl border-[#bababa] border-l w-full min-h-screen overflow-y-auto"
      style={{
            ...
            <table className="text-sm w-full text-left bg-white rounded-tl-xl rounded-br-xl">
              <thead className="text-base text-black">
                <tr>
                  ...
                  <th className="px-6 py-3 font-semibold">Start Date & Time</th>
