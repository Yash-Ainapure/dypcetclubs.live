...
import { FaGithub, FaRegCopyright, FaLinkedinIn } from 'react-icons/fa';
...
const Footer = () => {
    ...
    const socialMedia = [
        ...
        { Icon: FaXTwitter, link: 'https://x.com/Yash_Ainapure', color: '#333' }, // Updated to FaTwitter
        {
            Icon: FaLinkedinIn, link: 'https://www.linkedin.com/in/yash-ainapure-3aa050270', color: '#0077B5'
        },
    ];
